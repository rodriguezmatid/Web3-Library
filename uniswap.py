...
web3 = Web3(Web3.HTTPProvider('https://eth-goerli.g.alchemy.com/v2/yDYcpM9PmK5vZgiZKxa7RUEno1GoCkAL'))
...
poolsDeseado = web3.toChecksumAddress(contractFactory.functions.getPair('0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6','0x07865c6E87B9F70255377e024ace6630C1Eaa37F').call())
print(poolsDeseado)
# # Quantity of pools
...
# nonce = web3.eth.getTransactionCount(account)
  ...
  #           })
# swap = routerContract.functions.swapExactETHForTokens(
#             1, #uint amountOutMin
#             ['0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6', token2Address], #address[] calldata path
#             account, #address to
#             int(time.time()) + (60*1) #uint deadline
#             ).buildTransaction({
#               'nonce': nonce,
